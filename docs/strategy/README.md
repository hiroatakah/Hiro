# OneWay 戦略OS — OneWay Enterprise AIOS
...
| 項目 | 内容 |
|---|---|
| 対象事業 | OneWay Enterprise AIOS（カテゴリー：Enterprise AI Operating System） |
| 最終更新 | 2026-08-31 |
...
| 問い | 答え |
|---|---|
| **何の会社か** | **AI Workforce Design Company（人とAIの労働力設計会社）**。人とAIを一つの労働力として設計する経営OS「**OneWay Enterprise AIOS**」を提供します。開発会社ではありません |
...
| **売上コミット** | **FY2027 5,000万 → FY2028 1億 → FY2029 3億**（[13](13-goal-plan-3y.md) が正）。5年上振れシナリオは総売上10.5億・ARR 8億（[08](08-execution-plan.md)） |
| **勝ち筋の型** | 獲得＝**ライトアップ型**（診断・ウェビナー・紹介網・補助金）、拡大＝**LayerX型**（コンパウンド・灯台顧客・公開文化）（[12](12-benchmark.md)） |
...
| **12** | [benchmark](12-benchmark.md) | LayerX×ライトアップ分析・移植プラン・**補助金ファイアウォール** | 施策を考えるとき / 競合を聞かれたとき |
| **13** | [goal-plan-3y](13-goal-plan-3y.md) | **3ヶ年必達計画（5,000万→1億→3億）・四半期実行・月次KPI** | **月次経営レビュー（最優先）** |
...
| **月次の経営レビュー** | **13（第6章 KPI）** → 11（B欄 実測値の更新） |
...
**売上コミット：FY2027 5,000万 → FY2028 1億 → FY2029 3億**（[13-goal-plan-3y.md](13-goal-plan-3y.md)）

**次にやること：** [08](08-execution-plan.md) 第7章 Month 1 / Week 1（商品定義・U-001決着・SA募集）＋ [13](13-goal-plan-3y.md) FY2026 Q4 のチェックリスト。

---

## 9. 一枚もの（サマリーページ）

`overview.html` は、この戦略OS全体を一枚で確認・共有するためのページのソースです。
公開版：https://claude.ai/code/artifact/a73056bf-5d24-49ef-b33f-02ea094a1902

**戦略文書を更新したら、このページも更新してください。** 数字がズレたページは、無いページより危険です。
